...
vim.keymap.set('n', '<Leader>wd', '<cmd>VimwikiDiaryIndex<CR>', { desc = 'Open diary' })
vim.keymap.set('n', '<Leader>we', '<cmd>VimwikiUIIndex<CR>', { desc = 'Wiki UI browser' })
vim.keymap.set('n', '<Leader>ws', '<cmd>VimwikiUISelect<CR>', { desc = 'Select wiki' })
vim.keymap.set('n', '<Leader>wc', '<cmd>VimwikiGitCommit<CR>', { desc = 'Git commit wiki' })
vim.keymap.set('n', '<Leader>wp', '<cmd>VimwikiGitPush<CR>', { desc = 'Git push wiki' })
vim.keymap.set('n', '<C-x>', '<cmd>VimwikiToggleListItem<CR>', { desc = 'Toggle list item' })
